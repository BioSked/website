import { a as createAstro, c as createComponent, r as renderComponent, b as renderTemplate, f as renderSlot } from './astro/server_B5cfr19O.mjs';
import 'piccolore';
...
const $$Button = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Element", Element, { "class": classes, "href": href, ...props }, { "default": ($$result2) => renderTemplate` ${renderSlot($$result2, $$slots["default"])} ` })}`;
}, "/Users/biofred/Documents/Dev/marketing-site/src/components/ui/Button.astro", void 0);
