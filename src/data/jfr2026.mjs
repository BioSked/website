...
export const SESSIONS = [
  ...
  },
  {
    ...
    duree: '45 min',
    format: 'Nouvelles fonctionnalités',
    titre: 'Journées types : publiez vos créneaux de rendez-vous sans ressaisie',
    description: 'Construire vos journées types dans Momentum et les publier dans votre outil de prise de rendez-vous. Disponible en pilote.',
    public: 'Responsables planning, secrétariat',
    valeurHubspot: '16:00 Journées types et rendez-vous',
    publiee: true,
  },
  {
    slug: 's1645',
