...
const baseCopy = {
  en: {
    ...
    supportFormDescription: 'Describe what\'s happening below and our support team will follow up by email.',
    formLoading: 'Loading the secure support form...',
    formFallback: 'The form did not load. Email us instead and we will get back to you.',
    formFallbackLink: 'Email support',
  ...
  fr: {
    ...
    supportFormDescription: 'Décrivez votre problème ci-dessous, notre équipe support vous répondra par e-mail.',
    formLoading: 'Chargement du formulaire de support sécurisé...',
    formFallback: 'Le formulaire ne s’est pas chargé. Écrivez-nous et nous vous répondrons.',
    formFallbackLink: 'Envoyer un e-mail au support',
