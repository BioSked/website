...
export const SESSIONS = [
  ...
  },
  {
    ...
    duree: '1 h 15',
    format: 'Présentation',
    titre: 'Momentum en 12 mois : les innovations clés et nos priorités',
    description: 'Les principales innovations introduites dans Momentum ces douze derniers mois, les sujets sur lesquels nous concentrons nos efforts, et un temps pour recueillir vos retours.',
    public: 'Tout public',
    valeurHubspot: '11:00 Innovations des 12 derniers mois',
    publiee: true,
  },
  {
    slug: 's1330',
