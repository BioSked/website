...
export const SESSIONS = [
  ...
  },
  {
    ...
    fin: '12:15',
    duree: '1 h 15',
    format: 'Atelier produit',
    titre: 'Gestion des temps : les prochaines évolutions, et votre avis',
    description: 'Ce qui arrive sur les congés, les compteurs et le pointage, sur mobile et sur le Web, présenté sur démonstrations et maquettes. Un atelier pour recueillir vos retours, sans engagement de date.',
    public: 'Responsables planning, RH, direction',
    valeurHubspot: '11:00 Atelier produit gestion des temps',
    publiee: true,
  },
  {
    slug: 's1330',
